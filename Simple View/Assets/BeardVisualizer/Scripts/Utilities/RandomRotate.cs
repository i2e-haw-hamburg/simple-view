...
public class RandomRotate : MonoBehaviour {
    ...
    IEnumerator Rotate()
    {
        ...
        HOTween.To(this.transform, Random.Range(0.1f, 10.0f), new TweenParms().NewProp("rotation", targetRotation).Ease((EaseType)easeTypes.GetValue(easeType)).OnComplete(() => this.StartCoroutine(this.Rotate())));
    }
}
